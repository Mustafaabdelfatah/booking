...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="/"><span>Booking</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

        <nav class="nav-menu d-none d-lg-block">
            <ul>
                <li style="padding-top: 20px" class="active"><a href="/">Home</a></li>

                @if (Route::has('login'))
                        @auth
                    <li style="padding-top: 20px">  <a href="{{ route('admin.index') }}" class="text-sm text-gray-700 underline">Dashboard</a> </li>
                        @else
                    <li style="padding-top: 20px">  <a href="{{ route('front.login') }}" class="text-sm text-gray-700 underline">Log in</a></li>
                        @if (Route::has('register'))
                        <li style="padding-top: 20px"><a href="{{ route('front.register') }}" class="text-sm text-gray-700 underline">Register</a></li>
                            @endif
                        @endauth
                @endif
                <li>
